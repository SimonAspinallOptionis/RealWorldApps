...
namespace Website.RealWorldApps
{
    public class Data
    {
        ...
        public void AddNews()
        {
            News.Add(new News { Headline = "This is a news story", Body = "This is the body of the news story" });
            News.Add(new News { Headline = "This is the second news story", Body = "This is the body of the second news story" });
        }
        ...
        {
            Coaches.Add(new Coach { Name = "Mike Halpin", Position = "Head Coach", ImgName = "MikeHalpin.jpg" });
        ...
        {
            Games.Add(new Game { OpponentName = "Childwall Academy", Organisation = "Childwall", Location = "Priestley College, Warrington", TipOff = new DateTime(2015, 01, 10, 12, 00, 00), CheshireScore = 52, OpponentScore = 64, WonGame = false });
            Games.Add(new Game { OpponentName = "Manchester Magic I", Organisation = "Manchester", Location = "Amaechi Centre, Manchester", TipOff = new DateTime(2014, 12, 21, 13, 00, 00), CheshireScore = 37, OpponentScore = 103, WonGame = false });
